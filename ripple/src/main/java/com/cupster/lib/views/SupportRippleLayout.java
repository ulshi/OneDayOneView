...
/**
 * 波纹视图布局
 * use libs/nineoldandroids-2.4.0.jar
 * api11以下不支持属性动画，使用nineoldandroids 属性动画
 */
public class SupportRippleLayout extends RelativeLayout{
     ...
     * @param context
     */
    public SupportRippleLayout(Context context) {
        super(context);
        init(context, null);
    }

    public SupportRippleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SupportRippleLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void generateRippleViews() {
        ...
        for (int i = 0; i < mRippleViewNums; i++) {
            SupportRippleLayout.RippleView rippleView = new SupportRippleLayout.RippleView(getContext());
     ...
     * @param i 视图所在的索引
     */
    private void addAnimToRippleView(SupportRippleLayout.RippleView rippleView, int i) {
    ...
    private void makeRippleViewsVisible() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView instanceof SupportRippleLayout.RippleView) {
