...
import com.cupster.navigationview.R.styleable;
...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = a.getDimensionPixelSize(styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = a.getColor(styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(styleable.CircleImageView_civ_border_overlay, false);
        this.mFillColor = a.getColor(styleable.CircleImageView_civ_fill_color, 0);
        a.recycle();
        this.init();
    }
