...
/**
 * Encoding by Cupster on 2020/1/6 11:18.
 */
public class Map4DetailBehavior extends AppBarLayout.Behavior {

    public Map4DetailBehavior() {
    }

    public Map4DetailBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
